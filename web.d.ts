...
declare namespace $ {
	...
	type $mol_vector_2d__86MPO18H = $mol_type_enforce<
		[ number, number ]
		,
		ConstructorParameters< typeof $mol_vector_2d<number> >
	>
	type $mol_vector_2d__G7GXF49T = $mol_type_enforce<
		[ number, number ]
		,
		ConstructorParameters< typeof $mol_vector_2d<number> >
	>
	type $mol_vector_2d__3T13D5RD = $mol_type_enforce<
		[ number, number ]
		,
		ConstructorParameters< typeof $mol_vector_2d<number> >
	>
...
declare namespace $ {
	...
	type $hyoo_aura_video__uri__SPNUP0PQ = $mol_type_enforce<
		ReturnType< $hyoo_aura['video_uri'] >
		,
		ReturnType< $hyoo_aura_video['uri'] >
	>
	type $hyoo_aura_video__drop__CM9VYOL2 = $mol_type_enforce<
		ReturnType< $hyoo_aura['shape_drop'] >
		,
		ReturnType< $hyoo_aura_video['drop'] >
	>
	type $mol_stack__sub__VCDTG6Q2 = $mol_type_enforce<
		ReturnType< $hyoo_aura['shapes'] >
		,
		ReturnType< $mol_stack['sub'] >
	>
	type $mol_view__sub__9YEF19VZ = $mol_type_enforce<
		readonly(any)[]
		,
	...
	type $hyoo_aura_video_output__uri__7QM1E49K = $mol_type_enforce<
		ReturnType< $hyoo_aura_video['uri'] >
		,
		ReturnType< $hyoo_aura_video_output['uri'] >
	>
	type $hyoo_aura_video_output__transform__TH1A9RKM = $mol_type_enforce<
		ReturnType< $hyoo_aura_video['transform'] >
		,
		ReturnType< $hyoo_aura_video_output['transform'] >
	>
	type $hyoo_aura_video_output__aspect__VPWXZ3X3 = $mol_type_enforce<
		ReturnType< $hyoo_aura_video['aspect'] >
		,
		ReturnType< $hyoo_aura_video_output['aspect'] >
	>
	type $mol_vector_2d__8MH3FUOZ = $mol_type_enforce<
		[ number, number ]
		,
		ConstructorParameters< typeof $mol_vector_2d<number> >
	>
	type $mol_touch__allow_draw__V6BAIOHV = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_touch['allow_draw'] >
	>
	type $mol_touch__zoom__7OXMKIJI = $mol_type_enforce<
		ReturnType< $hyoo_aura_video['zoom'] >
		,
		ReturnType< $mol_touch['zoom'] >
	>
	type $mol_touch__pan__XVXO1AEB = $mol_type_enforce<
